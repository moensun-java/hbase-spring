...
public interface HbaseOperations {
	...
	/**
	 *  Puts 多个 value in to the given table.
	 *
	 * @param tableName  target table
	 * @param rowName    row name
	 * @param familyName family
	 * @param cellDate column- data
	 */
	void put(String tableName, final String rowName, final String familyName, final Map<String, byte[]> cellDate);
